"""grey_nuns_casa_hub_21945 URL Configuration
...
admin.site.site_header = "Grey Nuns Casa-Hub"
admin.site.site_title = "Grey Nuns Casa-Hub Admin Portal"
admin.site.index_title = "Grey Nuns Casa-Hub Admin"

# swagger
api_info = openapi.Info(
    title="Grey Nuns Casa-Hub API",
    default_version="v1",
    description="API documentation for Grey Nuns Casa-Hub App",
)
